---
title: "Widget Overview in the Web Modeler"
parent: "app-settings-wm"
category: "Web Modeler"
description: "Describes the Widget Overview tab in the App Setting in the Mendix Web Modeler."
menu_order: 
...
**Widget Overview** contains information on Mendix App Store widgets and local widgets in your app. For more details on widgets, see [Widgets in the Web Modeler](page-editor-widgets-wm).

## 2 Widget Overview

**App Settings** contains an overview of all App Store widgets and local widgets in your project.

![](attachments/widget-overview-wm/wm-widget-overview-tab-screen.png)

The following types of widgets are included into the widget overview:
...
In the Widget Overview the following columns are displayed:
